...
func (c *chatServiceClient) SendChat(ctx context.Context, in *Chat, opts ...grpc.CallOption) (*Chat, error) {
	out := new(Chat)
...
func (UnimplementedChatServiceServer) SendChat(context.Context, *Chat) (*Chat, error) {
...
func _ChatService_SendChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).SendChat(ctx, req.(*Chat))
	}
